...
function LoginForm({ supabaseClient, modalOnClose }) {
  ...
  return (
    <Form
      ...
      onSubmit={(e) => {
        ...
        signInUser(supabaseClient, data.email, data.password).then(
          ({error}) => {
            if (!error) {
              modalOnClose();
            } else {
        ...
        <ModalContent>
          {(onClose) => {
            return (
              <>
                <ModalBody>
                  <LoginForm supabaseClient={supabaseClient} modalOnClose={onClose}/>
                </ModalBody>
              </>
            );
          }}
